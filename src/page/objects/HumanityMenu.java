...
private static final String BTNSETTINGS="//a[@id='sn_admin']//span[@class='primNavQtip__inner']";
	...
	public static WebElement getBTNSettings(WebDriver driver) {
		return driver.findElement(By.xpath(REPORTS_XPATH));
	}
	public static void clickBTNSettings(WebDriver driver) {
